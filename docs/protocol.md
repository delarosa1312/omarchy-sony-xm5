# The MDR protocol, as this device actually behaves

Notes taken while making the daemon work, kept because most of it is not
written down anywhere and none of it is guessable. Every claim here was
established against a WH-1000XM5 or a WF-1000XM5 -- usually by writing
something, reconnecting, and seeing what had really stuck.

The widget and its install live in the [README](../README.md).
